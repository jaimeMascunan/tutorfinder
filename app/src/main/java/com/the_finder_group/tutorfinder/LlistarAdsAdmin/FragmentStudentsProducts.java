...
/**
 * Fragment en que mostrarem per a l'usuari administrador tots els anuncis publicats per usuaris student
...
public class FragmentStudentsProducts extends Fragment {
    ...
    @Override
    /**
     * Override del metode onCreateView en que inflarem la recycleview que correspon al fragment on visualitzarem els anuncis dels usuaris student
     */
    ...
    @Override
    /**
     * Override del metode onViewCreated on inicialitzem la recycleview i hi asignem el llistat d'anuncis pel usuaris student i l'adaptador
     */
     ...
     */
    public void fetchCoursesUser(){ new obtindreLlistatRole().execute(); }
    ...
    private class obtindreLlistatRole extends AsyncTask<String, Void, List<AdDTO>> {
        ...
        protected List<AdDTO> doInBackground(String... strings) {
            List<AdDTO> llistatProductesRole = tfClientImple.listProductsAdmin(USER_CODE_STUDENTS, getActivity().getApplicationContext());
            //Obtenim el llistat amb les dades solicitades
